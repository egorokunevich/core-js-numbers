...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  ...
  const vectorModule1 = Math.hypot(x1, y1);
  const vectorModule2 = Math.hypot(x2, y2);
  const angleCos = dotProduct / (vectorModule1 * vectorModule2);
